    ...
    <div className="flex h-screen bg-zinc-950 overflow-hidden w-full">
      ...
      <main className="relative flex-1 min-w-0 overflow-y-auto overflow-x-hidden pt-14 md:pt-0">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none select-none fixed left-1/2 md:left-[calc(50%+7.5rem)] top-1/2 w-[650px] max-w-[80vw] opacity-20 z-0 -translate-x-1/2 -translate-y-1/2 -rotate-45"
        />
