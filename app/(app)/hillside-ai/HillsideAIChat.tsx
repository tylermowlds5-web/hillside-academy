  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)] md:h-screen max-w-3xl mx-auto w-full p-4 sm:p-6 gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-zinc-50">Hillside AI</h1>
          <p className="text-sm text-zinc-400">Ask about jobs, routes, and plants</p>
        </div>
      </div>
        ...
        {messages.length === 0 ? (
          <div className="h-full flex items-center justify-center">
            <p className="text-zinc-500 text-sm text-center max-w-xs">
              Ask a question about a job, a route, or a plant — like &ldquo;How do we trim boxwoods?&rdquo;
            </p>
          </div>
        ) : (
              ...
              message.role === 'user' ? (
                ...
                <div key={i} className="flex items-end gap-2 max-w-[85%]">
                  ...
                  <div className="bg-plum-light border border-plum text-tan rounded-2xl rounded-bl-sm px-4 py-2.5 text-sm whitespace-pre-wrap">
                    {message.content === '' ? (
                      <span className="flex gap-1 py-1" aria-label="Hillside AI is typing">
