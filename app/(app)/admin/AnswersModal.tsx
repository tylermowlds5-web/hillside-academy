...
// Shared admin modal that renders a quiz attempt's per-question breakdown
// (chosen vs. correct, with sequence questions getting per-slot detail). Used
// by the employee detail page and the assign-video tab.
