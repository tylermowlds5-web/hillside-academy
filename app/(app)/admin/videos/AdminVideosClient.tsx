  ...
  return (
    <div className="p-4 sm:p-6 w-full max-w-5xl mx-auto">
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-opacity duration-200 ${showAddVideo ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className={`relative w-full max-w-3xl max-h-[90vh] bg-zinc-950 border border-zinc-800 rounded-2xl flex flex-col shadow-2xl overflow-hidden transition-transform duration-200 ${showAddVideo ? 'scale-100' : 'scale-95'}`}>
